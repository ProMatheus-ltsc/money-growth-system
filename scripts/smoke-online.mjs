 ...
 *   例：node scripts/smoke-online.mjs https://money-growth-sys.pages.dev FAM2026 admin admin123456
 *
 * 前置：已初始化管理员账号（POST /api/auth/init 完成）。
 */
const BASE = (process.argv[2] || 'https://money-growth-sys.pages.dev').replace(/\/$/, '');
